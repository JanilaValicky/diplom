...
get_current_screen()->add_help_tab(
    [
        ...
        'content' => '<p>' . __('Many themes show some sidebar widgets by default until you edit your sidebars, but they are not automatically displayed in your sidebar management tool. After you make your first widget change, you can re-add the default widgets by adding them from the Available Widgets area.') . '</p>' .
...
if (isset($_GET['editwidget']) && $_GET['editwidget']) {
    ...
    foreach ($wp_registered_sidebars as $sbname => $sbvalue) {
        ...
        if ($sbname === 'wp_inactive_widgets' || str_starts_with($sbname, 'orphaned_widgets')) {
            echo '&nbsp;';
        } else {

...
if (!empty($_GET['network_admin_hash'])) {
    ...
    exit;
} elseif (!empty($_GET['dismiss']) && $_GET['dismiss'] === 'new_network_admin_email') {
...
get_current_screen()->add_help_tab(
    [
        'id' => 'overview',
        'title' => __('Overview'),
        'content' => '<p>' . __('This screen sets and changes options for the network as a whole. The first site is the main site in the network and network options are pulled from that original site&#8217;s options.') . '</p>' .

...
$menu[2] = [__('Dashboard'), 'manage_network', 'index.php', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'dashicons-dashboard'];
...
$menu[5] = [__('Sites'), 'manage_sites', 'sites.php', '', 'menu-top menu-icon-site', 'menu-site', 'dashicons-admin-multisite'];
$submenu['sites.php'][5] = [__('All Sites'), 'manage_sites', 'sites.php'];
$submenu['sites.php'][10] = [__('Add New Site'), 'create_sites', 'site-new.php'];

$menu[10] = [__('Users'), 'manage_network_users', 'users.php', '', 'menu-top menu-icon-users', 'menu-users', 'dashicons-admin-users'];
...
if (current_user_can('update_themes') && $update_data['counts']['themes']) {
    ...
    $menu[15] = [__('Themes'), 'manage_network_themes', 'themes.php', '', 'menu-top menu-icon-appearance', 'menu-appearance', 'dashicons-admin-appearance'];
}
...
if (current_user_can('update_plugins') && $update_data['counts']['plugins']) {
    ...
    $menu[20] = [__('Plugins'), 'manage_network_plugins', 'plugins.php', '', 'menu-top menu-icon-plugins', 'menu-plugins', 'dashicons-admin-plugins'];
}
...
$menu[25] = [__('Settings'), 'manage_network_options', 'settings.php', '', 'menu-top menu-icon-settings', 'menu-settings', 'dashicons-admin-settings'];

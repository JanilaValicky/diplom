...
$is_template_part = isset($_GET['postType']) && sanitize_key($_GET['postType']) === 'wp_template_part';
$is_template_part_path = isset($_GET['path']) && sanitize_key($_GET['path']) === 'wp_template_partall';

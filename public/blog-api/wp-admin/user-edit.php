    ...
    default:
        ...
        ?>
                ...
                do_action('admin_color_scheme_picker', $user_id);
					...
					<?php } // End if count ( $_wp_admin_css_colors ) > 1?>
        ...
        ?>
					<?php if ($show_password_fields) { ?>
						...
						<table class="form-table" role="presentation">
							...
							<?php } // End Show Password Fields.?>

							<?php // Allow admins to send reset password link.?>
							<?php if (!IS_PROFILE_PAGE && wp_is_password_reset_allowed_for_user($profile_user) === true) { ?>
        ...
        ?>
				...
				<?php } // End Display Additional Capabilities.?>

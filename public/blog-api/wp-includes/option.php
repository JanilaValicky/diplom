...
function wp_prime_option_caches($options)
{
    ...
    foreach ($options as $option) {
        if (
            (!isset($cached_options[$option]) || $cached_options[$option] === false)
...
function wp_set_option_autoload_values(array $options)
{
    ...
    foreach ($options as $option => $autoload) {
        ...
        if ($autoload === 'no' || $autoload === false) { // Sanitize autoload value and categorize accordingly.
...
function wp_load_core_site_options($network_id = null)
{
    ...
    $core_options = ['site_name', 'siteurl', 'active_sitewide_plugins', '_site_transient_timeout_theme_roots', '_site_transient_theme_roots', 'site_admins', 'can_compress_scripts', 'global_terms_enabled', 'ms_files_rewriting'];
...
function update_option($option, $value, $autoload = null)
{
    ...
    if (!wp_installing()) {
        ...
        } elseif ($update_args['autoload'] === 'yes') {

        ...
        if (!empty($info['quicktime']['comments']['location.ISO6709'])) {
            ...
            foreach ($info['quicktime']['comments']['location.ISO6709'] as $ISO6709string) {
                ...
                if (preg_match('#^([\\+\\-])([0-9]{2}|[0-9]{4}|[0-9]{6})(\\.[0-9]+)?([\\+\\-])([0-9]{3}|[0-9]{5}|[0-9]{7})(\\.[0-9]+)?(([\\+\\-])([0-9]{3}|[0-9]{5}|[0-9]{7})(\\.[0-9]+)?)?/$#', $ISO6709string, $matches)) {
                    ...
                    @[$dummy, $lat_sign, $lat_deg, $lat_deg_dec, $lon_sign, $lon_deg, $lon_deg_dec, $dummy, $alt_sign, $alt_deg, $alt_deg_dec] = $matches;
            ...
            switch ($atomname) {
                                            ...
                                            case 21: // tmpo/cpil flag
                                                switch ($atomname) {
                                                    ...
                                                    case 'covr':
                                                        ...
                                                        $info['quicktime']['comments']['picture'][] = ['image_mime' => $atom_structure['image_mime'], 'data' => $atom_structure['data'], 'description' => 'cover'];
                                                        break;
                ...
                case 'tkhd': // TracK HeaDer atom
                    ...
                    switch ($atom_structure['matrix_a'] . ':' . $atom_structure['matrix_b'] . ':' . $atom_structure['matrix_c'] . ':' . $atom_structure['matrix_d']) {
                        case '1:0:0:1':         $matrixRotation = 0;
                            break;
                        case '0:1:65535:0':     $matrixRotation = 90;
                            break;
                        case '65535:0:0:65535': $matrixRotation = 180;
                            break;
                        case '0:65535:1:0':     $matrixRotation = 270;
                            break;
                        default: break;
                    }
                ...
                case "\xA9" . 'xyz':  // GPS latitude+longitude+altitude
                    ...
                    if (preg_match('#([\\+\\-][0-9\\.]+)([\\+\\-][0-9\\.]+)([\\+\\-][0-9\\.]+)?/$#i', $atom_data, $matches)) {
                        @[$all, $latitude, $longitude, $altitude] = $matches;
                ...
                case 'thma': // subatom to "frea" -- "ThumbnailImage"
                    // https://www.sno.phy.queensu.ca/~phil/exiftool/TagNames/Kodak.html#frea
                    if (strlen($atom_data) > 0) {
                        $info['quicktime']['comments']['picture'][] = ['data' => $atom_data, 'image_mime' => 'image/jpeg', 'description' => 'ThumbnailImage'];
                    }
                    break;
                case 'scra': // subatom to "frea" -- "PreviewImage"
                    ...
                    if (strlen($atom_data) > 0) {
                        $info['quicktime']['comments']['picture'][] = ['data' => $atom_data, 'image_mime' => 'image/jpeg', 'description' => 'PreviewImage'];
                    }
                    break;

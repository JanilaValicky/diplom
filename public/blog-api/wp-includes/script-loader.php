...
function wp_default_scripts($scripts)
{
    ...
    $scripts->add('jquery-ui-button', "/wp-includes/js/jquery/ui/button$suffix.js", ['jquery-ui-core', 'jquery-ui-controlgroup', 'jquery-ui-checkboxradio'], '1.13.2', 1);
    $scripts->add('jquery-ui-datepicker', "/wp-includes/js/jquery/ui/datepicker$suffix.js", ['jquery-ui-core'], '1.13.2', 1);
    $scripts->add('jquery-ui-dialog', "/wp-includes/js/jquery/ui/dialog$suffix.js", ['jquery-ui-resizable', 'jquery-ui-draggable', 'jquery-ui-button'], '1.13.2', 1);
    ...
    $scripts->add('user-profile', "/wp-admin/js/user-profile$suffix.js", ['jquery', 'password-strength-meter', 'wp-util'], false, 1);
...
function wp_enqueue_stored_styles($options = [])
{
    ...
    $should_prettify = isset($options['prettify']) ? $options['prettify'] === true : defined('SCRIPT_DEBUG') && SCRIPT_DEBUG;

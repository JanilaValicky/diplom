...
class wpdb
{
    ...
    public function prepare($query, ...$args)
    {
        ...
        while ($key < $split_query_count) {
            ...
            if ($type === 'f' && $this->allow_unsafe_unquoted_parameters === true
                /*
                ...
                if ($type === 'i') {
                     ...
                     */
                    if ($this->allow_unsafe_unquoted_parameters !== true
                        /*
                         * Note: str_ends_with() is not used here, as this file can be included
                         * directly outside of WordPress core, e.g. by HyperDB, in which case
                         * the polyfills from wp-includes/compat.php are not loaded.
    ...
    public function placeholder_escape()
    {
         ...
         */
        if (has_filter('query', [$this, 'remove_placeholder_escape']) === false) {
    ...
    public function has_cap($db_cap)
    {
         ...
         * the polyfills from wp-includes/compat.php are not loaded.
         */
        if ($db_version === '5.5.5' && strpos($db_server_info, 'MariaDB') !== false

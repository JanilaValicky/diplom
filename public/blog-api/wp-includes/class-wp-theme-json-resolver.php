...
class WP_Theme_JSON_Resolver
{
    ...
    protected static function translate($theme_json, $domain = 'default')
    {
        if (static::$i18n_schema === null) {
            ...
            static::$i18n_schema = $i18n_schema === null ? [] : $i18n_schema;
        }
    ...
    {
        if (static::$core !== null && static::has_same_registered_blocks('core')) {
            return static::$core;
        }
    ...
    public static function get_theme_data($deprecated = [], $options = [])
    {
        ...
        if (static::$theme === null || !static::has_same_registered_blocks('theme')) {
    ...
    public static function get_block_data()
    {
        ...
        if (static::$blocks !== null && static::has_same_registered_blocks('blocks')) {
    ...
    {
        if (static::$user !== null && static::has_same_registered_blocks('user')) {
            return static::$user;
        }
